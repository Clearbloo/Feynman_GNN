...
class AntiUp_b(Particle):
  ...
  """
  def __init__(self):
    Particle.__init__(self,m=m_up,S=0.5,LIW=0,LY=-4/3,RIW=-0.5,RY=-1/3,anti_colour=[0,1,0])
...
class AntiTop_b(Particle):
  ...
  """
  def __init__(self):
    Particle.__init__(self,m=m_top,S=0.5,LIW=0,LY=-4/3,RIW=-0.5,RY=-1/3,anti_colour=[0,1,0])
